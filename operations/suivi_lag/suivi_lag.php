            ...
            <div class="div_filtre_shop_ext">
                ...
                <div id="div_shop_ext_2">
                    <div id="div_shop_ext_2_1">
                        <button type="button" class="btn btn-success" id="btn_import_fichier_excel" data-bs-toggle="modal" data-bs-target="#modal_import"> Importer</button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal_body">
                    <form id="form_import_fichier_suivi_lag">
                        ...
                        <input type="text" name="import_fichier" id="id_import_fichier" value="import_fichier" hidden>
                    </form>
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="button_import_fichier_suivi_lag">Importer</button>
                </div>
