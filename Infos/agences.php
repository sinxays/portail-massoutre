...
<body>
    ...
    <main>
        ...
        <div class="container_form_recherche">
            <div class="my_div_recherche">
                <div class="element_filtre">
                    <label for="input_search_agence">Rechercher une agence</label>
                    <input type="text" class="form-control" id="input_search_agence" placeholder="agence">
                </div>
            </div>
        </div>
        ...
        <table class="my_tab_perso" id="table_agences_infos"> </table>
    ...
    <script src="../assets/js/infos_agences.js"></script>
</body>
