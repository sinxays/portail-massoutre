...
$suivi_lag_table_header_row = array("Immatriculation", "Marque", "Modele", "Km Echoes", "Type alerte", "Libelle code", "Date (entretien)", "Km (entretien)", "Client", "Dernier Commentaire", "  ");
