        ...
        <div id="menu_1">
            ...
            if (isset($_SESSION['user_id'])) {
                ...
                <div class="nav__list">
                    <div class="nav__items">
                        ...
                        <?php if (hasRole([1])) { ?>
                            <div class="nav__dropdown">
                                <a href="#" class="nav__link">
                                    ...
                                    <span class="nav__name">Informatique</span>
                                    <i class='bx bx-chevron-down nav__icon nav__dropdown-icon'></i>
                                </a>
                        ...
                        <div class="nav__dropdown">
                            ...
                            <div class="nav__dropdown-collapse">
                                <div class="nav__dropdown-content">
                                    <a href="/payplan/payplan.php" class="nav__dropdown-item">Payplan</a>
                                    <a href="/payplan/grille_de_gestion.php" class="nav__dropdown-item">Grille de
                                        gestion</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="nav__items">
                    ...
                    <a href="/Liste_telephonique/liste_telephonique.php" class="nav__link" id="menu_liste_telephnique">
            ...
            <div id="menu_2">
                <a href="/parametres.php" class="nav__link nav_param">
