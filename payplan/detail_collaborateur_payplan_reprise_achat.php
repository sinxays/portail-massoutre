...
<body>
    ...
    <main>
        ...
        if (isset($_GET['id_detail_collaborateur_payplan_reprise']) && $_GET['id_detail_collaborateur_payplan_reprise'] !== '') {
            $id_collaborateur_detail = $_GET['id_detail_collaborateur_payplan_reprise'];
