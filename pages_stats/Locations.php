...
-->
            ...
            <div class="my_div_form">
                ...
                <input type="date" id="date_locations_stats" style="border-radius: 5px;height: 40px;"
                    placeholder="Date de locations stats" />
            </div>
        ...
        <div id="wrap">
            <div class="container">
                <div class="row">
                    <form id="upload_csv_form" class="form-horizontal" method="post" name="upload_csv_form"
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" id="bloc_date_import_csv">
                                    ...
                                    <input type="date" id="date_import_stats" name="date_csv"
                                        style="border-radius: 5px;" />
                                    <button style="margin-left: 20px;" type="submit" id="submit" name="Import"
        ...
        <div id="wrap">
            <div class="container">
                ...
                <div class="form-group">
                    <div class="col-md-8">
                        <button id="bouton_alimenter_tableau" class="btn btn-warning">Alimenter Table VP VU
                            CUMUL</button>
                ...
                <div class="csontainer">
                    <div class="form-group">
                        <div class="col-md-8">
                            ...
                            <button id="bouton_vider_table_vp_vu_cumul" class="btn btn-danger">Vider Table VP VU
                                CUMUL</button>
