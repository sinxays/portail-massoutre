        ...
        <main>
            ...
            <div class="container-fluid px-4 py-4"> <!-- ================================================= -->
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2 class="mb-1"> <i class="bx bx-user"></i> Modifier un utilisateur </h2>
                        <p class="text-muted mb-0"> Modification du compte <?= htmlspecialchars($user['prenom']) ?>
                        ...
                        <form method="POST">
                            <div class="row g-4"> <!-- =============================== --> <!-- NOM -->
                                ...
                                <div class="col-md-6"> <label for="prenom" class="form-label"> Prénom </label> <input
                                        ...
                                        value="<?= htmlspecialchars($user['prenom']) ?>" required> </div>
                                <!-- =============================== --> <!-- EMAIL -->
                                <!-- =============================== -->
                                ...
                                <div class="col-md-6"> <label for="role_id" class="form-label"> Rôle </label> <select
                                        ...
                                        <?php foreach ($roles as $role): ?>
                                            <option value="<?= htmlspecialchars($role['id']) ?>"
                                                ...
                                                <?= htmlspecialchars($role['libelle_role']) ?> </option> <?php endforeach; ?>
                                    </select> </div> <!-- =============================== --> <!-- ACTIF -->
                                <!-- =============================== -->
                                <div class="col-md-6"> <label class="form-label"> Statut </label>
                                    <div class="form-check form-switch mt-2"> <input class="form-check-input"
                                            type="checkbox" role="switch" id="actif" name="actif" <?= $user['actif'] ? 'checked' : '' ?>> <label class="form-check-label" for="actif"> Utilisateur
                                            actif </label> </div>
                                </div>
                            </div> <!-- ================================================= --> <!-- BOUTONS -->
                            <!-- ================================================= -->
                            ...
                            <div class="d-flex justify-content-end gap-2"> <a href="utilisateurs.php"
                                    ...
                                    class="btn btn-primary"> <i class="bx bx-save"></i> Enregistrer les modifications
                                </button> </div>
                        </form>
                    </div>
                </div>
